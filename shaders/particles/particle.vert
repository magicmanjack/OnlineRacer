...
uniform vec3 u_offset; // Offset relative to emitter.
uniform vec2 u_size;
...
void main() {
    ...
    vec3 vertex_worldspace = u_emitter_world_pos + u_offset + camera_right * a_position.x * u_size.x + camera_up * a_position.y * u_size.y; 
